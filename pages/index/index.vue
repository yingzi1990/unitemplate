	...
	<view>
		...
		<view class="header" :style="{position:headerPosition}">
			...
			<view class="input">
				...
				<input placeholder="商品标题" @click="pageTo('/pages/index/search')" />
			</view>
			<view class="menu">
				...
				<swiper	class="swiper" duration="300" :style="{ height: categoryHeight }" @change="categoryChange">
					<swiper-item v-for="(page, pageindex) in categoryList" :key="pageindex" >
						<view class="category-list">
							<view class="icon" v-for="category in page" :key="category.cat_id" @click="pageTo('/pages/goods/goodslist')">
		...
		<view class="pick">
			<view class="box">
				...
				<view class="product-list">
					<view v-for="product in pickList" :key="product.goods_id">
		...
		<!-- 广告横幅 -->
		<view class="banner">
			<image mode="widthFix" src="/static/swiper/banner.jpg"></image>
		</view>
		<!-- 商品列表 -->
		<view class="goods-list">
			<view class="title">— 猜你喜欢 —</view>
			<view class="product-list">
				<view class="product" v-for="product in productList" :key="product.goods_id" @click="pageTo('/pages/goods/detail',1,{'id':product.id})">
					<image mode="widthFix" :src="product.img"></image>
...
export default {
	data() {
		return {
			//轮播
			swiperList:[
				{id:0,src:'自定义src0',img:'/static/swiper/0.jpg'},
				{id:1,src:'自定义src1',img:'/static/swiper/1.jpg'},
				{id:2,src:'自定义src2',img:'/static/swiper/2.jpg'},
				{id:3,src:'自定义src3',img:'/static/swiper/3.jpg'}
			],
			//分类
			categoryList: [
				[//第一页
					{ cat_id: 0, img: '/static/icon/0.png', title: '吹风机' },
					{ cat_id: 1, img: '/static/icon/1.png', title: '发箍' },
					{ cat_id: 2, img: '/static/icon/2.png', title: '肥皂' },
					{ cat_id: 3, img: '/static/icon/3.png', title: '粉饼' },
					{ cat_id: 4, img: '/static/icon/4.png', title: '化妆镜' },
					{ cat_id: 5, img: '/static/icon/5.png', title: '睫毛膏' },
					{ cat_id: 6, img: '/static/icon/6.png', title: '睫毛夹' },
					{ cat_id: 7, img: '/static/icon/7.png', title: '精华' },
					{ cat_id: 8, img: '/static/icon/8.png', title: '口红' },
					{ cat_id: 9, img: '/static/icon/9.png', title: '面膜' }
				],
				[//第二页
					{ cat_id: 10, img: '/static/icon/10.png', title: '面霜' },
					{ cat_id: 11, img: '/static/icon/11.png', title: '乳液' },
					{ cat_id: 12, img: '/static/icon/12.png', title: '梳子' },
					{ cat_id: 13, img: '/static/icon/13.png', title: '刷子' },
					{ cat_id: 14, img: '/static/icon/14.png', title: '洗脸仪' },
					{ cat_id: 15, img: '/static/icon/15.png', title: '洗面奶' },
					{ cat_id: 16, img: '/static/icon/16.png', title: '香水' }
				]
			],
			//推荐商品 3个
			pickList:[
				{ goods_id: 0, img: '/static/good/p1.jpg', price: '￥168', slogan:'限时抢购' },
				{ goods_id: 1, img: '/static/good/p2.jpg', price: '￥168', slogan:'精选商品' },
				{ goods_id: 2, img: '/static/good/p3.jpg', price: '￥168', slogan:'今日疯抢' }
			],
			//猜你喜欢列表
			productList:[
				{ goods_id: 0, img: '/static/good/p1.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 1, img: '/static/good/p2.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 2, img: '/static/good/p3.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 3, img: '/static/good/p4.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 4, img: '/static/good/p5.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 5, img: '/static/good/p6.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 6, img: '/static/good/p7.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 7, img: '/static/good/p8.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 8, img: '/static/good/p9.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 9, img: '/static/good/p10.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' }
			],
			categoryHeight: '75px',
			currentPageindex: 0,
