		...
		data() {
			return {
				goodsList:[
					...
					{id:2,img:'/static/good/p1.jpg',name:'商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题',spec:'规格:S码',price:127.5,number:1,selected:false},
					{id:3,img:'/static/good/p1.jpg',name:'商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题商品标题',spec:'规格:S码',price:127.5,number:1,selected:false},
				],
				shopList:[
					{id:1,name:"冰鲜专卖店",img:"/static/good/p1.jpg"},
					{id:2,name:"果蔬天下",img:"/static/good/p1.jpg"},
					{id:3,name:"办公耗材用品店",img:"/static/good/p1.jpg"},
					{id:4,name:"天天看好书",img:"/static/good/p1.jpg"}
				],
				headerTop:0,
				//控制滑动效果
				typeClass:'goods',
